          ...
          <div class="col-12">
            ...
            <!-- Black transparent bg -->           
                  <?php
                    ...
                    $data = $conn->query($sql);
                    // $banner_show =mysqli_fetch_object($data);
                    $banner_show = $data->fetch_object(); 
                  ?>
            <div class="ml-auto mr-0 tm-bg-black-transparent text-white tm-brand-container-inner">
              <div class="tm-brand-container text-center">
                <h1 class="tm-brand-name"><?php echo $banner_show->title ?></h1>
                <p class="tm-brand-description mb-0"><?php echo $banner_show->tag ?></p>
              </div>
            </div>
          </div>
        </div>
